...
export interface SiteSettings {
  ...
  vrising_free_plot_icon_url: string;
...
export interface AdminSiteSettings {
  ...
  vrising_free_plot_icon_set?: boolean;
  vrising_hide_admins?: boolean;
  maintenance_mode?: boolean;
}
