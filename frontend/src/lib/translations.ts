...
export const translations = {
  en: {
    ...
    vRisingMapTier: "Tier",
    vRisingMapFreePlot: "Free plot",
    vRisingMapFreePlots: "Free plots",
    vRisingMapFullscreen: "Fullscreen",
    vRisingMapExitFullscreen: "Exit fullscreen",
    ...
    adminSettingsVRisingHideAdmins: "Hide server admins on live map",
    adminSettingsVRisingHideAdminsHint: "Admin players will not be shown on the live map or included in the player count.",
    adminSettingsVRisingMapURL: "Map Image URL",
    adminSettingsVRisingMapURLHint: "External URL of the Vardoran map texture. Leave empty — the uploaded file or /vrising-map.png will be used automatically.",
    adminSettingsVRisingMapUpload: "Upload Map Image",
    ...
    adminSettingsVRisingCastleIcon: "Castle Icon",
    adminSettingsVRisingCastleIconUpload: "Upload castle icon",
    adminSettingsVRisingCastleIconHint: "Custom icon for castles on the live map. PNG/WebP, max 1 MB. Leave empty to use the default diamond shape.",
    adminSettingsVRisingCastleIconUploaded: "Castle icon uploaded",
    adminSettingsVRisingCastleIconClear: "Remove castle icon",
    adminSettingsVRisingPlayerIcon: "Player Icon",
    adminSettingsVRisingPlayerIconUpload: "Upload player icon",
    ...
    maintenanceSubtitle: "The site is temporarily unavailable. Please check back later.",
    adminMaintenanceMode: "Maintenance mode",
    adminMaintenanceModeHint: "Closes the site for all non-admin users",
    adminMaintenanceModeWarn: "Warning: enabling this will hide the site from all non-admin users",
    // Overview / Dashboard
    adminOverviewPlayersOnline: "Players Online",
    adminOverviewServersOnline: "Servers Online",
    adminOverviewTotalUsers: "Total Users",
    adminOverviewTotalServers: "Total Servers",
    adminOverviewTopServers: "Top Servers",
    adminOverviewRecentActivity: "Recent Activity",
    adminOverviewRecentUsers: "Recent Registrations",
    adminOverviewServersWeek: "Servers added (7d)",
    adminOverviewUsersToday: "Registered today",
    adminOverviewNoTopServers: "No online servers",
    adminOverviewNoActivity: "No recent activity",
    adminOverviewServersOffline: "Servers Offline",
    adminOverviewPeakPlayers: "Peak Players Today",
    adminOverviewTopOffline: "Recently Offline",
    adminOverviewPlayers24h: "Players Online (24h)",
    adminOverviewQuickActions: "Quick Actions",
    adminOverviewAlerts: "Alerts",
    adminOverviewNoOfflineServers: "All servers online",
    adminHealthRefreshIn: "Updating in",
    // Quick Actions
    adminQaNews: "News",
    adminQaAudit: "Audit",
    // Alert messages ({n}, {total} are replaced at runtime)
    adminAlertOfflineCritical: "{n} of {total} servers offline",
    adminAlertOfflineWarn: "{n} servers offline",
    adminAlertGoroutines: "High goroutine count: {n}",
    adminAlertMemory: "High memory usage: {used}/{total} MB",
    // Stats charts
    adminStatsRegByWeek: "Registrations by week",
    adminStatsGameDist: "Servers by game type",
    chartLabelPlayers: "Players",
    chartLabelRegistrations: "Registrations",
    chartLabelServers: "Servers",
    // System Health
    adminHealthTitle: "System Health",
    adminHealthUptime: "Uptime",
    adminHealthMemory: "Memory",
    adminHealthGoroutines: "Goroutines",
    adminHealthWsConns: "WS Connections",
    adminHealthDb: "DB Pool",
    adminHealthDbOpen: "open",
    adminHealthDbInUse: "in use",
    adminHealthDbIdle: "idle",
    adminHealthGcRuns: "GC runs",
    adminHealthGoVersion: "Go",
    // Backup & Restore
  ...
  ru: {
    ...
    vRisingMapFreePlot: "Свободный участок",
    vRisingMapFreePlots: "Свободных участков",
    vRisingMapFullscreen: "На весь экран",
    vRisingMapExitFullscreen: "Выйти из полноэкранного режима",
    ...
    adminSettingsVRisingHideAdmins: "Скрывать администраторов сервера на живой карте",
    adminSettingsVRisingHideAdminsHint: "Игроки-администраторы не будут отображаться на живой карте и учитываться в счётчике игроков.",
    adminSettingsVRisingMapURL: "URL изображения карты",
    adminSettingsVRisingMapURLHint: "Внешний URL текстуры карты Вардорана. Оставьте пустым — загруженный файл или /vrising-map.png будет использован автоматически.",
    adminSettingsVRisingMapUpload: "Загрузить изображение карты",
    ...
    adminSettingsVRisingCastleIcon: "Иконка замка",
    adminSettingsVRisingCastleIconUpload: "Загрузить иконку замка",
    adminSettingsVRisingCastleIconHint: "Кастомная иконка для замков на живой карте. PNG/WebP, максимум 1 МБ. Оставьте пустым — будет использован стандартный ромб.",
    adminSettingsVRisingCastleIconUploaded: "Иконка замка загружена",
    adminSettingsVRisingCastleIconClear: "Удалить иконку замка",
    adminSettingsVRisingPlayerIcon: "Иконка игрока",
    adminSettingsVRisingPlayerIconUpload: "Загрузить иконку игрока",
    ...
    maintenanceSubtitle: "Сайт временно недоступен. Зайдите позже.",
    adminMaintenanceMode: "Режим обслуживания",
    adminMaintenanceModeHint: "Закрывает сайт для всех не-администраторов",
    adminMaintenanceModeWarn: "Внимание: включение скроет сайт от всех не-администраторов",
    // Overview / Dashboard
    adminOverviewPlayersOnline: "Игроков онлайн",
    adminOverviewServersOnline: "Серверов онлайн",
    adminOverviewTotalUsers: "Всего пользователей",
    adminOverviewTotalServers: "Всего серверов",
    adminOverviewTopServers: "Топ серверов",
    adminOverviewRecentActivity: "Последние события",
    adminOverviewRecentUsers: "Новые регистрации",
    adminOverviewServersWeek: "Серверов добавлено (7 дн.)",
    adminOverviewUsersToday: "Зарегистрировалось сегодня",
    adminOverviewNoTopServers: "Нет онлайн-серверов",
    adminOverviewNoActivity: "Нет недавних событий",
    adminOverviewServersOffline: "Серверов офлайн",
    adminOverviewPeakPlayers: "Пик игроков сегодня",
    adminOverviewTopOffline: "Недавно упали",
    adminOverviewPlayers24h: "Игроков онлайн (24ч)",
    adminOverviewQuickActions: "Быстрые действия",
    adminOverviewAlerts: "Предупреждения",
    adminOverviewNoOfflineServers: "Все серверы онлайн",
    adminHealthRefreshIn: "Обновление через",
    // Quick Actions
    adminQaNews: "Новость",
    adminQaAudit: "Аудит",
    // Alert messages ({n}, {total} are replaced at runtime)
    adminAlertOfflineCritical: "{n} из {total} серверов офлайн",
    adminAlertOfflineWarn: "{n} серверов офлайн",
    adminAlertGoroutines: "Высокое число горутин: {n}",
    adminAlertMemory: "Высокое потребление памяти: {used}/{total} MB",
    // Stats charts
    adminStatsRegByWeek: "Регистрации по неделям",
    adminStatsGameDist: "Серверы по типу игры",
    chartLabelPlayers: "Игроков",
    chartLabelRegistrations: "Регистрации",
    chartLabelServers: "Серверов",
    // System Health
    adminHealthTitle: "Состояние системы",
    adminHealthUptime: "Аптайм",
    adminHealthMemory: "Память",
    adminHealthGoroutines: "Горутины",
    adminHealthWsConns: "WS-соединений",
    adminHealthDb: "Пул БД",
    adminHealthDbOpen: "открыто",
    adminHealthDbInUse: "используется",
    adminHealthDbIdle: "свободно",
    adminHealthGcRuns: "запусков GC",
    adminHealthGoVersion: "Go",
    // Backup & Restore
