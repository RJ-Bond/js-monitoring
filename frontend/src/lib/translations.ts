...
export const translations = {
  en: {
    ...
    adminSettingsNewsTGThread: "Topic (Thread)",
    adminSettingsNewsTGThreadHint: "For supergroups with Topics enabled. Leave empty to post to the main chat.",
    adminSettingsNewsTGThreadLoad: "Load topics",
    adminSettingsNewsTGThreadLoading: "Loading…",
    adminSettingsNewsTGThreadError: "Failed to load topics. Make sure the bot is an admin in the supergroup.",
    adminSettingsNewsTGThreadNone: "Main chat (no topic)",
  ...
  ru: {
    ...
    adminSettingsNewsTGThread: "Тема (топик)",
    adminSettingsNewsTGThreadHint: "Для супергрупп с включёнными темами. Оставьте пустым для публикации в основной чат.",
    adminSettingsNewsTGThreadLoad: "Загрузить темы",
    adminSettingsNewsTGThreadLoading: "Загрузка…",
    adminSettingsNewsTGThreadError: "Не удалось загрузить темы. Убедитесь, что бот является администратором супергруппы.",
    adminSettingsNewsTGThreadNone: "Основной чат (без темы)",
