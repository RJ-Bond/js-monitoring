...
func main() {
	...
	v1.GET("/news/tags", api.GetNewsTags)
	...
	admin.POST("/news/tags", api.CreateNewsTag)
	admin.PUT("/news/tags/:id", api.UpdateNewsTag)
	admin.DELETE("/news/tags/:id", api.DeleteNewsTag)
